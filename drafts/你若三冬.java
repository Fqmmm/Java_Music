...
public class 你若三冬 implements MusicDraft {
    ...
    // --- 主歌部分的乐句定义保持不变 ---
    public static final Lyric 远方谁为了谁 = Lyric.fromPlayables("远方谁为了谁",
        // ... (此处省略未改动的主歌部分)
        Note.halfNote(low[6]),
    ...
    public static final Lyric 一直望穿秋水 = Lyric.fromPlayables("一直望穿秋水",
        Note.halfNote(medium[2]),
        Note.halfNote(medium[1]),
        Note.halfNote(medium[2]),
    ...
    public static final Lyric 是谁为谁月下贪杯 = Lyric.fromPlayables("是谁为谁月下贪杯",
    ...
    public static final Lyric 谁能看穿红尘放眼又有几人回 = Lyric.fromPlayables("谁能看穿红尘放眼又有几人回",
    ...
    public static final Lyric 落的念念不忘收尾 = Lyric.fromPlayables("落的念念不忘收尾",
        Note.halfNote(medium[6]),
        Note.halfNote(medium[5]),
        Note.halfNote(medium[6]),
        Note.halfNote(high[1]),
    ...
    public static final Lyric 拥抱何必太过沉醉 = Lyric.fromPlayables("拥抱何必太过沉醉",
        Note.halfNote(high[1]),
        Note.halfNote(medium[7]),
        Note.halfNote(medium[5]),
        Note.halfNote(medium[3]),
    ...
    public static final Lyric 你若三冬来换我一城雪白 = Lyric.fromPlayables("你若三冬来换我一城雪白",
    ...
    public static final Lyric 漫天相思片片风中开 = Lyric.fromPlayables("漫天相思片片风中开",
            new Note(medium[6] + increment_scale, 0.5, CHORUS_INSTRUMENT),
            new Note(high[1] + increment_scale, 0.5, CHORUS_INSTRUMENT),
            new Note(high[2] + increment_scale, 0.5, CHORUS_INSTRUMENT),
            new Note(high[3] + increment_scale, 0.5, CHORUS_INSTRUMENT),
    ...
    public static final Lyric 轻轻摇曳在天边划过的精彩 = Lyric.fromPlayables("轻轻摇曳在天边划过的精彩",
            new Note(medium[6] + increment_scale, 0.5, CHORUS_INSTRUMENT),
            new Note(high[1] + increment_scale, 0.5, CHORUS_INSTRUMENT),
            new Note(high[2] + increment_scale, 0.5, CHORUS_INSTRUMENT),
            new Note(high[3] + increment_scale, 0.5, CHORUS_INSTRUMENT),
    ...
    public static final Lyric 化作眼泪哭着醒来 = Lyric.fromPlayables("化作眼泪哭着醒来",
            new Note(medium[6] + increment_scale, 0.5, CHORUS_INSTRUMENT),
            new Note(medium[5] + increment_scale, 0.5, CHORUS_INSTRUMENT),
            new Note(medium[6] + increment_scale, 0.5, CHORUS_INSTRUMENT),
            new Note(high[1] + increment_scale, 0.5, CHORUS_INSTRUMENT),
    ...
    public static final Lyric 梦过子时回首你不再 = Lyric.fromPlayables("梦过子时回首你不再",
            new Note(medium[6] + increment_scale, 0.5, CHORUS_INSTRUMENT),
            new Note(high[1] + increment_scale, 0.5, CHORUS_INSTRUMENT),
            new Note(high[2] + increment_scale, 0.5, CHORUS_INSTRUMENT),
            new Note(high[3] + increment_scale, 0.5, CHORUS_INSTRUMENT),
    ...
    public static final Lyric 每逢落叶过挥手南雁几排 = Lyric.fromPlayables("每逢落叶过挥手南雁几排",
            new Note(medium[6] + increment_scale, 0.5, CHORUS_INSTRUMENT),
            new Note(high[1] + increment_scale, 0.5, CHORUS_INSTRUMENT),
            new Note(high[2] + increment_scale, 0.5, CHORUS_INSTRUMENT),
            new Note(high[3] + increment_scale, 0.5, CHORUS_INSTRUMENT),
