...
public class TestGuitarChordsHardCode {
    public static void main(String[] args) throws Exception {
        ...
        guitar.reset();
        guitar.guitarStrings[4].setFret(3); // 5弦3品
        guitar.guitarStrings[3].setFret(2); // 4弦2品
        guitar.guitarStrings[1].setFret(1); // 2弦1品
        // 3弦和1弦是0品，reset后已经是了
        ...
        guitar.reset();
        guitar.guitarStrings[5].setFret(3); // 6弦3品
        guitar.guitarStrings[4].setFret(2); // 5弦2品
        guitar.guitarStrings[0].setFret(3); // 1弦3品
